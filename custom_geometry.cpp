...
void CustomGeometry::setNormals(bool enable)
{
...
void CustomGeometry::setNormalXY(float xy)
{
    if (m_normalXY == xy)
        return;
...
void CustomGeometry::setUV(bool enable)
{
    if (m_hasUV == enable)
        return;
...
void CustomGeometry::setUVAdjust(float f)
{
    if (m_uvAdjust == f)
        return;
